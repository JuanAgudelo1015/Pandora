// Uso de extends para crear un nuevo html element personalizado, 
// es decir hereda del elemento HTMLElement
export class Footer extends HTMLElement {
    constructor() {
        // Llamando al constructro de la clase base HTMLElement
        super();
        this.innerHTML = /*html*/`
...
<i class="fab fa-linkedin-in"></i>
    ...
    <div class="footer-bottom footer-border-top light py-3">
        <div class="container text-center">
            <p class="m-0">© 2021 copyright <a href="../new_messages.html" class="text-reset text-white">Bootdey.com</a></p>
        </div>
    </div>
</footer>
        `
